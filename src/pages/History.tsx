      ...
      className="w-full md:mt-10 bg-neutral-100 h-auto lg:h-[90dvh] flex lg:mt-40 justify-center items-center">
        ...
        className="w-5/6 mx-auto h-auto lg:h-10/12 flex flex-col lg:flex-row justify-between">
          ...
          className="w-full lg:w-3/5">
            <h1
            className="mb-5 lg:mb-0 text-[48px] font-bold text-black text-center lg:text-left  md:text-[96px] lg:mt-[-120px] flex flex-col gap-0">
              <span className="text-[36px] md:text-3xl text-primary lg:mb-[-30px]">The</span>
              Tipitaka
            </h1>
            <section
